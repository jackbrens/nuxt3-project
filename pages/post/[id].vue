<template>
	<div class="article">
		...
		<div class="author-info-box">
			...
			<div class="meta-box">
				<time datetime="2023-08-02T13:47:27.000Z" title="Wed Aug 02 2023 21:47:27 GMT+0800 (中国标准时间)" class="time">
					2023-08-02 21:47
				</time>
				<svg
					width="16"
...
const post = ref('')
const { data }: any = await getArticleDetail(route.params.id as string)
